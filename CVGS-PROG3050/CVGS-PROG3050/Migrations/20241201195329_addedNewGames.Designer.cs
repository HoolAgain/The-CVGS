...
namespace CVGS_PROG3050.Migrations
{
    ...
    [Migration("20241201195329_addedNewGames")]
    partial class addedNewGames
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CVGS_PROG3050.Entities.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CVGS_PROG3050.Entities.Game", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2009, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            GameId = 7,
            ...
            modelBuilder.Entity("CVGS_PROG3050.Entities.Order", b =>
                {
                    ...
                    b.Property<int?>("UserPaymentPaymentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserPaymentPaymentId");
            ...
            modelBuilder.Entity("CVGS_PROG3050.Entities.Friend", b =>
                {
                    b.HasOne("CVGS_PROG3050.Entities.User", "FriendUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CVGS_PROG3050.Entities.Order", b =>
                {
                    ...
                    b.HasOne("CVGS_PROG3050.Entities.UserPayment", "UserPayment")
                        .WithMany()
                        .HasForeignKey("UserPaymentPaymentId");
